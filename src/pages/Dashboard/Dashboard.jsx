...
import { FaFileInvoiceDollar, FaShoppingCart, FaUsers, FaTshirt, FaBars } from 'react-icons/fa'; 
                ...
                <div className="menu-container">
                    ...
                    {showMenu && (
                        <div className="menu-dropdown">
                            <button className="logout-button" style={{background:'none',border:'none'}} onClick={handleLogout}>
                                Logout
                            </button>
                        </div>
                    )}
